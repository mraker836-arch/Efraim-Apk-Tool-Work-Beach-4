...
android {
  ...
  signingConfigs {
    ...
    val isDebugKeystore = releaseKeystore != null && releaseKeystore.name == "debug.keystore"

    create("release") {
      if (releaseKeystore != null && releaseKeystore.exists()) {
        storeFile = releaseKeystore
        storePassword = if (isDebugKeystore) "android" else (System.getenv("STORE_PASSWORD") ?: "android")
        keyAlias = if (isDebugKeystore) "androiddebugkey" else (System.getenv("KEY_ALIAS") ?: "upload")
        keyPassword = if (isDebugKeystore) "android" else (System.getenv("KEY_PASSWORD") ?: System.getenv("STORE_PASSWORD") ?: "android")
      }
    }
